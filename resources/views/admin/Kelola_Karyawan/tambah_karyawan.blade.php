            ...
            <form action="{{ route('admin.store_karyawan') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-1 text-center hover:border-red-500 transition relative h-64">
                            <input type="file" name="foto" accept="image/*" class="hidden" id="fotoInput">
                            
                            <label for="fotoInput" class="cursor-pointer absolute inset-0 flex flex-col items-center justify-center z-10 w-full h-full rounded-lg overflow-hidden group">
                                <img id="fotoPreview" class="hidden w-full h-full object-cover absolute inset-0 z-0" alt="Preview Foto">
                                <div id="uploadPlaceholder" class="w-full h-full flex flex-col items-center justify-center z-10 transition-all duration-300 opacity-100 bg-transparent">
                                    <svg class="w-12 h-12 text-gray-400 mx-auto mb-2 group-hover:text-red-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                                    </svg>
                                    <p class="text-sm text-gray-500 group-hover:text-red-500 transition-colors" id="uploadText">Klik untuk upload foto</p>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" name="email" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Password</label>
                            <input type="password" name="password" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Jabatan</label>
                            <input type="text" name="jabatan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>
