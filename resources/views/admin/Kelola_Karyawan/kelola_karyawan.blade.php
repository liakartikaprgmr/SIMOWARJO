                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($karyawan as $k)
                            <tr>
                                <td class="px-6 py-4">
                                    <img src="{{ $k->foto ? asset($k->foto) . '?v=' . $k->updated_at->timestamp : 'https://i.pravatar.cc/40?u=' . $k->id_karyawan }}"
                                        class="w-12 h-10 object-cover rounded" alt="Foto Karyawan">
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        <a href="{{ route('admin.edit_karyawan', $k->id_karyawan) }}"
                                        ...
                                        <form action="{{ route('admin.delete_karyawan', $k->id_karyawan) }}" method="POST"
                                            class="inline"
