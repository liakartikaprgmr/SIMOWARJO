...
<body class="bg-gray-100">
    ...
    <header class="fixed top-0 left-0 right-0 h-16 bg-white shadow flex items-center justify-between px-6">
        ...
        <div class="relative">
            <button id="profileBtn" class="flex items-center gap-2 focus:outline-none hover:bg-gray-50 p-2 rounded-lg transition">
                <img src="{{ $user?->foto ? url($user->foto) : 'https://i.pravatar.cc/40' }}" class="w-10 h-10 rounded-full object-cover" alt="Profile">
                <div class="text-sm text-left">
                    <p class="font-semibold">{{ $user?->nama ?? 'Guest User' }}</p>
                    <p class="text-gray-500 text-xs leading-tight">{{ $user?->email ?? 'Not Logged In' }}</p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
            
            @if(auth()->check())
            <div id="profileDropdown" class="hidden absolute right-0 mt-1 w-48 bg-white border border-gray-100 rounded-lg shadow-lg py-2 z-50">
    ...
    class="fixed top-16 left-0 w-64 h-screen bg-red-800 text-white pt-6 pb-20 overflow-y-auto transform -translate-x-full md:translate-x-0 transition-transform duration-300">
        <nav class="px-4 space-y-6">
            ...
            <div>
                ...
                <div>
                    <button id="gajiBtn" class="w-full flex items-center justify-between p-2 rounded-lg hover:bg-red-700 focus:outline-none">
                        ...
                        <svg id="gajiIcon" class="w-4 h-4 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <!-- Sub-menu -->
                ...
                <div>
                    <button id="keuanganBtn" class="w-full flex items-center justify-between p-2 rounded-lg hover:bg-red-700 focus:outline-none">
                        <div class="flex items-center gap-2">
                        ...
                        <svg id="keuanganIcon" class="w-4 h-4 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <!-- Sub-menu -->
                    <div id="keuanganDropdown" class="hidden mt-1 space-y-1 pl-4">
                        ...
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"/></svg>
                            Pendapatan
                        </a>
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M16 18l2.29-2.29-4.88-4.88-4 4L2 7.41 3.41 6l6 6 4-4 6.3 6.29L22 12v6z"/></svg>
                            Pengeluaran
                        </a>
                    </div>
                </div>
            ...
            <div>
                ...
                <div>
                    <button id="presensiBtn" class="w-full flex items-center justify-between p-2 rounded-lg hover:bg-red-700 focus:outline-none">
                        <div class="flex items-center gap-2">
                        ...
                        <svg id="presensiIcon" class="w-4 h-4 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <!-- Sub-menu -->
                    <div id="presensiDropdown" class="hidden mt-1 space-y-1 pl-4">
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8s8 3.58 8 8s-3.58 8-8 8"/><path fill="currentColor" d="M12.5 7H11v6l5.25 3.15l.75-1.23l-4.5-2.67z"/></svg>
                            Kehadiran
                        </a>
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7v-5z"/></svg>
                            Jadwal Shift
                        </a>
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M22 5.18L10.59 16.6l-4.24-4.24l1.41-1.41l2.83 2.83l10-10zM12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8c1.57 0 3.04.46 4.28 1.25l1.45-1.45A10 10 0 0 0 12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.73 0 3.36-.44 4.78-1.22l-1.5-1.5c-1 .46-2.11.72-3.28.72m7-5h-3v2h3v3h2v-3h3v-2h-3v-3h-2z"/></svg>
                ...
                <div>
                    <button id="stokBtn" class="w-full flex items-center justify-between p-2 rounded-lg hover:bg-red-700 focus:outline-none">
                        <div class="flex items-center gap-2">
                        ...
                        <svg id="stokIcon" class="w-4 h-4 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <!-- Sub-menu -->
                    <div id="stokDropdown" class="hidden mt-1 space-y-1 pl-4">
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4v2h16zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6zm-9 4H6v-4h6z"/></svg>
                            Daftar Stok
                        </a>
                        <a href="#" class="flex items-center gap-2 p-2 rounded-lg hover:bg-red-700 text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2s-.9-2-2-2M1 2v2h2l3.6 7.59l-1.35 2.45c-.16.28-.25.61-.25.96c0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12l.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49A1.003 1.003 0 0 0 20 4H5.21l-.94-2zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2s2-.9 2-2s-.9-2-2-2"/></svg>
                            Pengadaan Barang
                        </a>
                    </div>
                </div>
