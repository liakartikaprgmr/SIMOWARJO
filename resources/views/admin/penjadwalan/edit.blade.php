...
@section('content')
    <div class="container mx-auto max-w-4xl mt-10 px-4 sm:px-6 lg:px-8">
        <div
            class="bg-red-800 text-white rounded-2xl px-8 py-6 shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-4">
            <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input list="karyawans" id="karyawan_input"
                            value="{{ old('karyawan_input', $jadwalData->karyawan ? $jadwalData->karyawan->nama : '') }}"
                    ...
                    <input type="hidden" name="id_karyawan" id="id_karyawan"
                        value="{{ old('id_karyawan', $jadwalData->id_karyawan) }}">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="shift" id="shift"
                            ...
                            required>
                            <option value="Pagi" {{ (old('shift') ?? $jadwalData->shift) == 'Pagi' ? 'selected' : '' }}>Pagi
                                (08:00 - 16:00)</option>
                            <option value="Malam" {{ (old('shift') ?? $jadwalData->shift) == 'Malam' ? 'selected' : '' }}>
                                Malam (20:00 - 04:00)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="date" name="tanggal_mulai"
                                value="{{ old('tanggal_mulai', $jadwalData->tanggal_mulai) }}"
                            ...
                            <input type="date" name="tanggal_selesai"
                                value="{{ old('tanggal_selesai', $jadwalData->tanggal_selesai) }}"
                                class="w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all duration-200"
                                required>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_masuk" id="jam_masuk"
                            value="{{ old('jam_masuk', \Carbon\Carbon::parse($jadwalData->jam_masuk)->format('H:i')) }}"
                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all duration-200"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_pulang" id="jam_pulang"
                            value="{{ old('jam_pulang', \Carbon\Carbon::parse($jadwalData->jam_pulang)->format('H:i')) }}"
                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all duration-200"
                            required>
                    </div>
                </div>
