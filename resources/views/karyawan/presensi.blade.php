...
<body class="bg-gray-100">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="col-span-1 lg:col-span-2">
                ...
                <div id="gpsPanel" class="hidden">
                    <div
                        class="mb-6 p-6 bg-gradient-to-br from-emerald-50 via-blue-50 to-indigo-50 rounded-2xl border-4 border-white/50 shadow-2xl backdrop-blur-sm">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <span id="gpsBadge2"
                                    class="bg-gradient-to-r from-emerald-600 to-green-600 text-white font-bold px-4 py-2 rounded-full text-sm shadow-lg">GPS
                                    Ready</span>
                                <span id="gpsAccuracy"
                                    class="text-sm font-semibold bg-white/80 px-3 py-1 rounded-full shadow-sm text-gray-800">Loading...</span>
                            </div>
                            <button onclick="toggleDebug()" class="p-2 hover:bg-white/50 rounded-lg transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="m12 5.5l6 4.5v1c.7 0 1.37.1 2 .29V9l-8-6l-8 6v12h7.68c-.3-.62-.5-1.29-.6-2H6v-9z" />
                                    <path fill="currentColor"
                ...
                <!-- CAMERA -->
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border-4 border-white/50 h-[380px]">
            ...
            <div
                ...
                <div id="riwayatAbsen" class="space-y-4">
                    @forelse($riwayat as $item)
                        <div
                            class="p-5 bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl border shadow-sm hover:shadow-md transition-all">
                            <!-- TANGGAL -->
    ...
    <!-- DEBUG PANEL -->
    <div id="debugGPS"
        class="fixed top-4 right-4 bg-gradient-to-b from-black/95 to-gray-900/90 backdrop-blur-xl text-white p-6 rounded-2xl shadow-2xl z-50 w-96 hidden border border-white/20">
        <h3 class="font-bold text-lg mb-4 flex items-center gap-3">
            ...
            GPS DEBUG
            <button onclick="document.getElementById('debugGPS').classList.add('hidden')"
                class="ml-auto text-gray-400 hover:text-white p-1 rounded-lg hover:bg-white/20 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
        ...
        <pre id="debugLog"
            class="text-xs max-h-64 overflow-auto bg-black/30 p-4 rounded-xl font-mono border border-white/20">Loading...</pre>
    </div>
    ...
    <script>
        ...
        function updateGPSBadge() {
            ...
            if (currentGPS && currentGPS.acc < 50 && currentGPS.jarak <= RADIUS_KANTOR) {
                ...
                badge1.className = 'bg-yellow-100 text-yellow-800 px-4 py-2 rounded-full text-sm shadow-sm animate-pulse';
