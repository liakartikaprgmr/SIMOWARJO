...
// Admin 
Route::middleware(['auth.check', 'role:supervisor,leader_shift'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware('role:supervisor')->group(function () {
            // Kelola Keuangan
            Route::prefix('kelola_keuangan')->name('kelola_keuangan.')->group(function () {
...
// Karyawan
Route::middleware(['auth.check', 'role:karyawan,supervisor,leader_shift'])->group(function () {
